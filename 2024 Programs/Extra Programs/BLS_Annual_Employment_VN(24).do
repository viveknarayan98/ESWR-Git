...
import delimited "${mypath}/Data/Raw/Macro Data Files/ce.industry.txt", clear 

save ce_industry_codes, replace

import excel "${mypath}/Data/Raw/Macro Data Files/Employmentbysector79-2023.xlsx", sheet("BLS Data Series") cellrange(A4:AU18) firstrow clear
