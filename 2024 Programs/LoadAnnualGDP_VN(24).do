* Build annual GDP panel from two BEA sources (1947-1997 and 1997-2023)
...
* ── 1947-1997: Load value added data and standardize industry names ──
...
* ── 1997-2023: Load BEA state GDP file, keep national totals only ──
...
* Splice the two files — match on Description to handle LineCode discrepancies across vintages
merge 1:1 Description using AnnualGDP_4797
*keep if _merge==3
rename linecode LineCode

* Keep only the industries used in the analysis
...
* Rename year columns from both files and reshape to long format
...
* Harmonize descriptions to match CPS industry groupings
...
* Diagnostic plot and crosswalk between trimmed labels and LineCodes
