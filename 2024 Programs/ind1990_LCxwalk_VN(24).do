* Build crosswalk from 1990 Census industry codes to BEA LineCodes
...
* Load raw 1990 industry code file and clean
...
* Map 1990 Census codes to BEA industry categories
...
* Merge to BEA LineCode crosswalk via trimmed description key
